...
function initOfferSlider(swiperClass) {
  console.log('initOfferSlider swiperINIT');
  const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]("." + swiperClass, {
    slidesPerView: 1,
    spaceBetween: 15,
    watchSlidesProgress: true,
    freeMode: true,
...
function initBannerSlider(swiperClass) {
  ...
  let swiperBanner = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]("." + swiperClass, {
    //direction: "vertical",
    effect: "creative",
    direction: "vertical",
    slidesPerView: 1,
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/views/components/swiper/swiper.scss");
/******/ 	
/******/ })()
;
