@php
    $classPrefix = 'promo-result-photo';
    $dataPrefix = 'data-promo-result-photo';

    $t = __('promo')['promo_result'];

    $images = [
        'img/results/ec2aeaf13ab4eb2b89d4cc6c941b82ef862c62b0.jpg',
         'img/results/619f43d7a07cd3d484761a0771916a73cc274078.jpg',

        'img/results/8d2bc8fb18470ba3d6ac8e7ad9ceaf944531f70a.jpg',
     'img/results/10e61532f18bfcb455f6a04a8224946a6b2e9bc5.jpg',

        'img/results/a487f23272e7cc7e99da5d214b8b830b10dcdad7.jpg',
        'img/results/d11d2c65bd36413303a01588dce8b0eb11a418c0.jpg',
...
<div {{ $dataPrefix }} class="{{ $classPrefix }}">
    ...
    <div style="display: none" class="{{ $classPrefix }}__footer">
